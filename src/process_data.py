"""
資料提取與處理腳本
從四個原始資料集 (DRCD, HotpotQA, 2WikiMultiHopQA) 中採樣並組裝文檔池。

輸出：
- data/processed/queries_raw.json: 60 筆 QA 對
- data/processed/corpus_raw.json: 600 篇文檔
"""
...
def collect_random_negatives(
    drcd_data: list[dict], used_contexts: set[str], target_count: int
) -> list[dict]:
    """
